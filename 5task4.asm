...
;here the swap function here 
    ...
    push ax              ; here we restore the previous value 
swap : mov ax,[bx+si]
        xchg ax,[bx+si+2]
        mov [bx+si],ax

        pop ax          ; again pop the value that we push into the satck 
        ret 


bubblesort :   push ax           ; all the previous value we stored into the stack 
               push cx
               push si
